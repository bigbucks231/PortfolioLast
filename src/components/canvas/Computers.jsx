...
const Computers = ({ isMobile }) => {
  ...
  return (
    <>
      ...
      <mesh scale={isMobile ? 0.7 : 0.75} position={isMobile ? [1, -3, -2.2] : [0, -3.25, -1.5]} rotation={[-0.01, -0.2, -0.1]} >
...
const ComputersCanvas = () => {
  ...
  useEffect(() => {
    ...
    // Defining a callback function to handle changes to the media query
